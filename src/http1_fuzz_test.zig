...
const validation = @import("http/protocol/http1/request/validation.zig");
const authority = @import("http/protocol/http1/request/authority.zig");
const head = @import("http/protocol/http1/request/head.zig");
const chunked = @import("http/protocol/http1/body/chunked.zig");
const connection = @import("http/protocol/http1/connection/root.zig");
const response_head = @import("http/protocol/http1/response/head.zig");
const response_plan = @import("http/protocol/http1/response/plan.zig");
